...
using Foms.ExceptionsHandler.Exceptions.ContractExceptions;
using Foms.Shared;
...
namespace Foms.Services
{
	...
	public class ServicesHelper
	{
		...
		/// <summary>
		/// Convert a NullableDouble to string
		/// </summary>
		/// <param name="date">NullableDouble to convert</param>
		/// <returns>Value</returns>
		/// <returns>String.Empty if exception has occured</returns>
		public static string ConvertNullableDoubleToString(double? number, bool isPercent)
		{
			if (number.HasValue)
			{
				...
				{
					if (isPercent)
						return Math.Round((number.Value * 100), 2,MidpointRounding.AwayFromZero).ToString();
					else
		...
		/// <summary>
		/// Convert a NullableDecimal to string
		/// </summary>
		/// <param name="date">NullableDecimal to convert</param>
		/// <returns>Value</returns>
		/// <returns>String.Empty if exception has occured</returns>
