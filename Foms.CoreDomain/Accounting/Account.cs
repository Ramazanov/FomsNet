...
namespace Foms.CoreDomain.Accounting
{
    ...
    public class Account
	{
        ...
        public Account(string accountNumber, string localAccountNumber, string label, OCurrency balance, string typeCode, bool debitPlus, int id, OAccountCategories category, int pCurrencyId)
        {
            _number = accountNumber;
            LocalNumber = localAccountNumber;
            _label = label;
