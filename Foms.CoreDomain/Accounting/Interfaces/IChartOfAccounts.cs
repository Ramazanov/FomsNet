...
namespace Foms.CoreDomain.Accounting.Interfaces
{
    public interface IChartOfAccounts
    {
        ...
        Account GetAccountByNumber(string number, int pCurrency_id, FundingLine pFundingLine, OBookingDirections pBookingDirection);
