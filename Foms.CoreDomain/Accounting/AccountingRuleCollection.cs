...
namespace Foms.CoreDomain.Accounting
{
    ...
    {
        private List<IAccountingRule> _rules;
        ...
        public Account GetSpecificAccount(string pNumber, ISavingsContract pSavings, OBookingDirections pBookingDirection)
        {
            ...
            query = query.Where(item => item.ClientType == OClientTypes.Both
        ...
        public Account GetSpecificAccount(string pNumber, IContract pContract, OBookingDirections pBookingDirection)
        {
            ...
            if (pContract is Loan)
                ...
                query = query.Where(item => item.ProductType == OProductTypes.All
                    || (item.ProductType == OProductTypes.Guarantee && (item.GuaranteeProduct == null || item.GuaranteeProduct.Id == pContract.Product.Id))).ToList();
        ...
        public Account GetSpecificAccount(string pNumber, FundingLine pFundingLine, OBookingDirections pBookingDirection)
        {
            var query = GetFundingLineAccountingRules();
            ...
            query = query.Where(item => item.FundingLine == null || item.FundingLine.Id == pFundingLine.Id).ToList();
