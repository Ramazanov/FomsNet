...
namespace Foms.CoreDomain.Accounting
{
    ...
    public class LoanScaleTable
    {
        ...
        private static readonly IDictionary<string, LoanScaleTable> _loanscaleTableList = new Dictionary<string, LoanScaleTable>();
        public static void SuppressRemotingInfos(string pMd5)
        {
            if (_loanscaleTableList.ContainsKey(pMd5))
            {
                _loanscaleTableList.Remove(pMd5);
            }
        }
        ...
        {
            if (!_loanscaleTableList.ContainsKey(pUser.Md5))
                _loanscaleTableList.Add(pUser.Md5, new LoanScaleTable());
            return _loanscaleTableList[pUser.Md5];
         }
