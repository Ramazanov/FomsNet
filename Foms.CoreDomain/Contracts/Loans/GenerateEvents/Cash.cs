...
namespace Foms.CoreDomain.Contracts.Loans.GenerateEvents
{
    public static class Cash
    {
        ...
        //public static void BookFundingLineEvent(FundingLine fLine, FundingLineEvent e, User pUser)
        //{
        //   IEventProcessor eP = new Events.Cash.EventProcessor(pUser, fLine.FundingLineChartOfAccounts, null);
        //   AccountingTransaction mS = eP.FireEvent(e, fLine.Currency.Id);
        //   if (mS != null) fLine.FundingLineChartOfAccounts.Book(mS);
        //}
    }
}
