...
namespace Foms.GUI
{
	...
	public class frmShowError : Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.buttonOK.Image = global::Foms.GUI.Properties.Resources.theme1_1_bouton_validity;
            ...
            this.buttonShowDetail.Image = global::Foms.GUI.Properties.Resources.theme1_1_view;
		...
		private void frmShowError_Load(object sender, EventArgs e)
		{
		    ...
		    labelExceptionText.Text = string.Format(_expectionStatus.message, ServicesProvider.GetInstance().GetGeneralSettings().GroupMinMembers);
